...
@JsonSubTypes({ @Type(value = CassandraConnector.class), @Type(value = DatabaseConnector.class),
		...
		@Type(value = AsciiDoctorTool.class), @Type(value = ApacheFopTool.class), @Type(value = ArchiverTool.class),
		@Type(value = CSVTool.class), @Type(value = FileCrawlerTool.class), @Type(value = FreeMarkerTool.class),
		@Type(value = IbanTool.class), @Type(value = MarkdownTool.class), @Type(value = ProcessTool.class),
		@Type(value = PropertiesTool.class), @Type(value = Rrd4jTool.class), @Type(value = ThymeleafTool.class),
